...
def page_team():
    if language == "Indonesia":
        ...
        | Nama | Peran |
        |------|-------|
        | **Muhammad Nurul Falah** | Algorithm Development & Integration |
        | **Rayyan Hasan Rabbani** | UI/UX Design & Image Processing |
        | **Tobias Dashiel Hapsoro** | Testing & Optimization |
        
        ### **Fitur Aplikasi:**
        
        **1. 🛠️ Image Tools:**
        - Transformasi matriks (translasi, scaling, rotasi)
        - Operasi konvolusi (filter blur, sharpen, edge detection)
        - Shearing dan refleksi
        
        **2. 🎭 Advanced Background Removal:**
        - 4 metode berbeda untuk hasil optimal
        - Support gambar dengan berbagai jenis background
        - Output format PNG dengan transparansi
        
        **3. 🌐 Multi-language Support:**
        - Bahasa Indonesia dan Inggris
        - Interface yang user-friendly
        - Panduan lengkap untuk setiap tool
        """)
        ...
        with col_guide1:
            ...
            **Untuk Image Tools:**
            ...
            2. Upload gambar yang ingin diproses
        ...
        with col_guide2:
            st.markdown("""
            **Untuk Background Removal:**
            1. Pilih halaman **Background Removal**
            2. Upload gambar dengan objek jelas
            3. Pilih metode (rekomendasi: GrabCut)
            4. Atur rectangle jika menggunakan GrabCut
            5. Proses dan download hasil
            """)
        ...
        **1. 🛠️ Image Tools:**
        ...
        - Convolution operations (blur, sharpen, edge detection filters)
        - Shearing and reflection
        
        **2. 🎭 Advanced Background Removal:**
        - 4 different methods for optimal results
        - Supports images with various background types
        - PNG output with transparency
        
        **3. 🌐 Multi-language Support:**
        - Indonesian and English languages
        - User-friendly interface
        - Complete guide for each tool
        """)
        ...
        with col_guide1:
            st.markdown("""
            **For Image Tools:**
            1. Select **Image Tools** page
            2. Upload image to process
        ...
        with col_guide2:
            ...
            **For Background Removal:**
            1. Select **Background Removal** page
            2. Upload image with clear object
            3. Choose method (recommended: GrabCut)
            4. Adjust rectangle if using GrabCut
            5. Process and download result
            """)
